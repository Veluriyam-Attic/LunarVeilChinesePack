...
public class BestiaryLocalizer : ModSystem {
    public override void Load() {
        ForceLocalizeSystem.LocalizeDerivedByType(typeof(ModNPC), nameof(ModNPC.SetBestiary), new() {
            ...
            { "Powerful skulls sent by skeletron to roam the darkness for the next pray", "填入汉化文本" }, // AbysmLunatic, ShadowWraith

            { "A scarecrow reanimated by the passion of wandering flames", "填入汉化文本" }, // Azurerin, Caeva, SolarPortal, GintziaHand
            ...
            { "A crystal which holds the power of summoning one of the three deities", "填入汉化文本" }, // BloodCyst, DreadMonolith, GraveShard
            ...
            { "Start to something bad", "填入汉化文本" }, // StartGoth, StartIrradia
            ...
            { "A poisonous slime mutated from normal green slimes", "填入汉化文本" }, // LazerOrb, SingularityOrb, SupernovaOrb, DreadFireCircle
            ...
            { "Commander Gintzia, the betrayer", "填入汉化文本" }, // CommanderGintzia, GintziaHand
