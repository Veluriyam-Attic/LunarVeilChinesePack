...
public class TownNPCLocalizer : ModSystem {
    public override void Load() {
        ...
        ForceLocalizeSystem.LocalizeByTypeName(nameof(Delgrim), nameof(Delgrim.OnChatButtonClicked), new() {
            ...
            { "Verlia always would be training the army, the gintze army wasn't exactly the most reliable mainly because of Verlia's idiocity and lack of care for danger. The army would always charge head first without a care for defense. I wonder where the army was when we were defending against the Carian warriors and knights", "因为薇莉亚那个笨蛋对危机意识的缺失，导致薇莉亚训练的玄铁军队实际上是并不可靠的。那支军队总是从不防御，只管冲锋在前。我在想，当我们在抵御卡利亚战士和骑士的时候，这支军队在哪里呢？" },
            { "Some days I look back on the Harboring Morrow and wonder why we fell so hard. I remember BORDOC, an excellent blacksmith but too arrogant to read his ways. Irradia taught me some amazing things I carry with me today and all the people. the people.. ", "有时候，我不自矜会回忆起在“幽曦城堡”的时光，思考我们为何会如此彻底地衰落。我记得有一个名为布兰德的出色的铁匠，但他过于自负，不愿改变自己的生活方式。伊瑞蒂安教给了我一些令我至今受益匪浅的惊人之事，还有所有的人们……那些人们……" },
            ...
            { "One harrowing day, a fox appears at the doorstep of Verlia and Gothivia's abode. I knew my eyes decieved me when I had seen the fox transform into a tall Nero, they are like human cats but I thought they'd been extinct for millenia! ", "在一个月黑风高的晚上，一只狐狸出现在薇莉娅和歌瑟梵的住宅门前。当我看到那只狐狸变成了一个高大的人形生物时，我才意识到她并不是狐狸，她是猫娘！！！但我以为她们种族已经灭绝了几千年了！" },
            ...
            { "After what I call the 'blue flash,' everyone hurried to a sign of screaming in the middle of the night. We all come to see Gothivia crying with a note in her hand and the fox lady. She introduced herself as Fenix. ", "“蓝色闪光”后，很多人急忙跑到尖叫发出的地方。但是我们只看到了手里拿着一张纸条哭泣的歌瑟梵，以及一位自称凤涅克斯狐狸女士。" },
            { "Fenix was a tall statured woman yet extremely menacing, at times a lot of us thought she may have been more powerful than Gothivia, but deep down Gothivia's suppressed feelings for her family would probably overcome that. ", "凤涅克斯是一位身材高大、看起来极其强大的女性，甚至我们中的很多人认为她比歌瑟梵更强大。但是大家又认为失去家人在悲痛爆发的歌瑟梵力量会更强大。" },
            { "The illnesses started to rack up and since Verlia disappeared, our Harboring Morrow was not complete, there was nobody to keep our armies in check, Gothivia wasn't mentally there anymore and Irradia was trying her best to get everyone to calm down. It was a horrible time.", "自从薇莉娅消失后，瘟疫快速蔓延，“幽曦城堡”已经名存实亡，没人维持军队秩序，歌瑟梵深受打击一蹶不振，伊瑞蒂安则在尽力让所有人冷静下来。那真是一段可怕的岁月。" },
            { "Irradia did explain what happened to Verlia, but I thought it was just downright evil. Fenix trapped Verlia's soul inside a lantern and bounded it to a secret power for experimentation because she stole a book from their village. We'll never get to see her again will we?", "伊瑞蒂安向我解释了在薇莉娅身上发生了什么。因为薇莉娅从凤涅克斯的村庄偷了一本书，凤涅克斯将薇莉娅的灵魂困在灯笼里，并用秘密力量上在她身上进行实验，这真是太邪恶了。我们或许再也见不到她了，对吧？" },
       ...
       ForceLocalizeSystem.LocalizeByTypeName(nameof(Ordin), nameof(Ordin.OnChatButtonClicked), new() {
        ...
        ForceLocalizeSystem.LocalizeInOrderByTypeName(nameof(Veldris), nameof(Veldris.OnChatButtonClicked), new() {
            ...
            { "Back in my day building this house was my masterpiece, Fenix really gathered up an army just to build this cathedral here and that temple below just to trap some harlet who took her stuff. Down right evil though on Fenix's behalf, maybe overkill. ", "之前，这栋建筑可算得上是大师之作.然后凤涅克丝集结了她的整支军队就为了建那座大殿堂来困住某位偷了她东西的婊子...要我说，纯纯的邪恶做法，而且太过了." },
