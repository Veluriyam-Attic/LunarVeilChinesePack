...
public class TownNPCLocalizer : ModSystem {
    public override void Load() {
        ...
        ForceLocalizeSystem.LocalizeByTypeName(nameof(Delgrim), nameof(Delgrim.OnChatButtonClicked), new() {
            ...
            { "After what I call the 'blue flash,' everyone hurried to a sign of screaming in the middle of the night. We all come to see Gothivia crying with a note in her hand and the fox lady. She introduced herself as Fenix. ", "“蓝色闪光”后，很多人急忙跑到尖叫发出的地方。但是我们只看到了手里拿着一张纸条哭泣的歌瑟梵，以及一位自称凤涅克丝的狐狸女士。" },
            { "Fenix was a tall statured woman yet extremely menacing, at times a lot of us thought she may have been more powerful than Gothivia, but deep down Gothivia's suppressed feelings for her family would probably overcome that. ", "凤涅克丝是一位身材高大、看起来极其强大的女性，甚至我们中的很多人认为她比歌瑟梵更强大。但是大家又认为失去家人、在悲痛爆发的歌瑟梵力量会更强大。" },
