    ...
    public class Gambit_Gambler_Tooltips : GlobalNPC
    {
        ...
        public override void GetChat(NPC npc, ref string chat)
        {
            ...
            if(name.Equals("Stellamod"))
            {
                ...
                chat = chat.Replace("Hii, it is a me, Zielie! I'm frantic at moments but what can you expect when your in a world full of death and loooove?", "你好，我叫泽丽！我有时会有点神经质，但在一个充满爱与死亡的世界中这样不是最好了吗！！");
                chat = chat.Replace("Ive heard that the morrow is very pretty, I talked to veribloom and she said her society is falling apart though so maybe not.", "听说幽曦之地很漂亮，但我问薇绿的时候她说她的社会已经快要完全失控了，我还是先不去那里了为妙.");
